...
public class AOStar_ConnectFour 
{
  ...
  public AOStar_ConnectFour(int w, int h) {
    width = w;
    height = h;
    grid = new char[h][];
  ...
  public static void main(String[] args) {
    ...
    try (Scanner input = new Scanner(System.in)) {
      ...
      // we create the AOStar_ConnectFour instance
      AOStar_ConnectFour board = new AOStar_ConnectFour(width, height);
